			...
			<div>
				...
				>
					<input v-model="name"
						   type="text"
						   placeholder="Name *"
						   class="py-3 px-4 bg-gray-50 border rounded-lg placeholder-gray-400 text-gray-900 appearance-none inline-block w-full shadow-md focus:outline-none focus:ring-2 focus:ring-green-500 dark:focus:ring-pink-500"
						   required
						   :disabled="sending"
						   v-bind:class="{'cursor-wait': sending}"
					>
					<textarea v-model="message"
							  rows="10"
							  class="py-3 px-4 bg-gray-50 border rounded-lg placeholder-gray-400 text-gray-900 appearance-none inline-block w-full shadow-md focus:outline-none focus:ring-2 focus:ring-green-500 dark:focus:ring-pink-500 mt-3"
							  placeholder="Message *"
							  required
							  :disabled="sending"
							  v-bind:class="{'cursor-wait': sending}"
					...
					<button type="submit"
							class="bg-gradient-to-r from-blue-500 to-green-500 dark:from-red-500 dark:to-pink-500 disabled:opacity-50 text-white p-3 rounded-lg w-full mt-3"
							:disabled="!canSubmit"
							v-bind:class="{'hover:from-blue-600 hover:to-green-600 dark:hover:from-red-600 dark:hover:to-pink-600': canSubmit, 'cursor-wait': sending}"
					>
